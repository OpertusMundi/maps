...
module.exports = require('./MapStore2/build/buildConfig')({
    bundles: {
        'maps': path.join(__dirname, "js", "app"),
        'maps-embedded': path.join(__dirname, "js", "embedded"),
        'maps-api': path.join(__dirname, "MapStore2", "web", "client", "product", "api"),
